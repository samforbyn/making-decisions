...
if (temperature >= 80 && rain === true){
  ...
  console.log("Wear 6 jackets, take an umbrella, buy a UPS + space heater because it's cold!!")
}else{
  console.log("Better go outside and look!")
}
...
//CODE HERE
newChangeMyMind = !changeMyMind
console.log(newChangeMyMind)
